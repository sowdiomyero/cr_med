...
<sec:authorize access="isAuthenticated()">
    ...
    <div class="container" id="contenantid">

        <div class="col-lg-12" >
            <h4 style="font-weight: bold;">Liste des Utilisateurs</h4>
            <div class="table-responsive" >
                <table id="table_utilisateurs" class="table table-bordred table-striped display"   border="0">
                    ...
                    <thead>
                        <tr  style="background-color: green;">
                            ...
                            <td style="font-weight: bold; background-color: skyblue">Téléphone </td>
                            <td style="font-weight: bold; background-color: skyblue">Email  </td>
                            <td style="font-weight: bold; background-color: skyblue">Login  </td>
                            <td style="font-weight: bold; background-color: skyblue">Supprimer</td>
                            <td style="font-weight: bold; background-color: skyblue">Editer</td>
                        </tr>
                    </thead>
                    <tbody>

                        <c:forEach items="${users}" var="user" >
                            <tr class="" id="${user.idUser}">
                                <td ><c:out value="${user.userPrenom}"></c:out></td>
                                <td><c:out value="${user.userName}"></c:out></td>
                                <td><c:out value="${user.userPhone}"></c:out></td>
                                <td><c:out value="${user.userMail}"></c:out></td>
                                <td><c:out value="${user.compte.login}"></c:out></td>
                                    <td >
