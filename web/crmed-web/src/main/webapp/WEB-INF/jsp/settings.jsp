                            ...
                            <div class="tabbable">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane " id="banque">
                                            ...
                                            <form:form commandName="banqueForm" action="${pageContext.request.contextPath}/settings/banque" method="post" id="banqueForm">
                                                <div class="" style="padding-top: 10px; margin-top: 10px">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="">
                                                                    ...
                                                                    <div class="panel-body" style="color: #000033">
                                                                        <div class="alert-success" id="banqueMessageSuccess" >
                                                                                <%-- <c:if test="${not empty message}">--%>
                                                                            <div class="alert-danger" style="display: none" id="banqueMessageFailed" >
                                                                                    <%--   <h2>${message} </h2> --%>
                                                                            </div>
                                                                                <%--  </c:if>--%>
                                                                        </div>
                                                                        <label for="hostInput">Code Banque: </label>
                                                                        <form:input class="form-control" required="required"  path="codeBanque" placeholder="BIS-123-0158 56" id="codeBanqueInput"/>


                                                                        <label for="portInput">Cigle Banque: </label>
                                                                        <form:input class="form-control" path="cigle" required="required"  id="cigleInput"/>


                                                                        <label for="emailInput">Contact Banque : </label>
                                                                        <form:input class="form-control" path="contact" required="required"  id="contactInput"/>

                                                                        <label for="emailInput">Url Validation Formulaire : </label>
                                                                        <form:input class="form-control" path="validationFormUrl"   id="validationFormUrlInput"/>

                                                                        <label for="emailInput">Url Du Webservice Esecure : </label>
                                                                        <form:input class="form-control" path="wsEndpointUrl"   id="wsEndpointUrlInput" />

                                                                        <label for="emailInput">Url Context Esecure : </label>
                                                                        <form:input class="form-control" path="frontEndUrl"  id="frontEndUrlInput" />

                                                                        <label for="emailInput">WS Auth : Login  </label>
                                                                        <form:input class="form-control" path="wsUsername" required="required"  id="wsUsernameInput" />

                                                                        <label for="emailInput">WS Auth : Mot De Passe </label>
                                                                        <form:input class="form-control" path="wsPassword" required="required" id="wsPasswordInput" />

                                                                        <form:input class="form-control" path="idBanque"  id="idBanqueInput" type="hidden"/>
