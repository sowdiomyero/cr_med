...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head>
        ...
        <script type="text/javascript" src="https://groupeidyal.atlassian.net/s/7445f1673c4f0ec4af08e92de75a1edf-T/fr_FRjns6pq/64014/25/1.4.24/_/download/batch/com.atlassian.jira.collector.plugin.jira-issue-collector-plugin:issuecollector/com.atlassian.jira.collector.plugin.jira-issue-collector-plugin:issuecollector.js?locale=fr-FR&collectorId=ad2ef015"></script>
        <!-- AJAX LOADER-->
                        ...
                        ajaxindicatorstop();
                            ...
                            <img   src="img/loading.gif" id="loading-indicator" style="display:none; " />
                                ...
                                <div class="wrap">
                                    ...
                                    <div id="masthead">
                                        <div class="container">
                                            <tiles:insertAttribute name="banniere"/>
                                        </div>
                                                        ...
                                                        <div class="col-md-12" id="leftCol">
                                                            <div class="panel panel-info">
                                                                ...
                                                                <div class="panel-body" style="color: #000033">
                                                                    ...
                                                                    <input class="form-control" name="prenom" required="required" placeholder="Votre Pr�nom" id="editProfilPrenomInput"/>
